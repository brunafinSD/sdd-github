...
- [ ] T113 [US-002] Implementar caixas separados Quadra e ADM — spec em specs/002-dual-cash-split/spec.md; branch 002-dual-cash-split; 3 user stories: (P1) Dashboard exibe saldo total + breakdown Quadra/ADM em fonte menor, (P2) finalização de jogo roteia pagamentos Na Quadra → caixa quadra e PIX → caixa ADM automaticamente, (P3) saque do caixa quadra: transferência para caixa ADM ou abatimento no custo de jogo pendente; requer /speckit.plan antes de implementar
